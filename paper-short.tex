...
We show that the ways in which languages order information reflect an underlying optimization principle: Human languages have evolved towards robustness against limitations in human working memory.
