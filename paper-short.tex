...
Human languages express hierarchically-structured thoughts into sentences, i.e. linear strings of words. \jd{too complicated for the general audience}
...
%TODO Underdiscussed: the theoretical result.


%maybe multiple sentences in def of It?
%explicit arcs making clear going back 1 word in the past, 2 words in the past? maybe matching between arcs and colors instead of the arrows?
...
%
%\begin{figure}
%\includegraphics[width=\textwidth]{figures/theorem.png}
%	\caption{Left: }\label{fig:theorem}
%\end{figure}
%

%\caption{A speaker (left) utters a sentence. A comprehender (right) maintains a noisy representation of prior words, and incurs surprisal upon hearing the next word.}
