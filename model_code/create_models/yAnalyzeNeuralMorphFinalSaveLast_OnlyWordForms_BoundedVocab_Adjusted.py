...
types = [" REAL ", " REAL_REAL ", "RANDOM_MODEL ", "RANDOM_BY_TYPE ", "RANDOM_MODEL_ST ", "RANDOM_BY_TYPE_ST ", "RANDOM_MODEL_CONS ", "RANDOM_BY_TYPE_CONS ", "RANDOM_MODEL_NONP ", "RANDOM_BY_TYPE_NONP ", " TOTALLY_RANDOM ", " GROUND ", " RANDOM_BY_TYPE_BRANCHING_ENT ", " GROUND_OVS ", " GROUND_SOV "]
...
#     print(result)
     ...
     if onlyOptimized: # changed this line (March 8, 2019)
       if type(finalShib[language]) == type((1,2)):
        ...
        #   print("Does not match hyperparams")
           continue
       else:
