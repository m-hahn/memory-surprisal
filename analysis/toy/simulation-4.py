...
dhWeights[stoi_deps["amod"]] = random.choice([-10, 10])
dhWeights[stoi_deps["nmod"]] = random.choice([-10, 10])
dhWeights[stoi_deps["case"]] = random.choice([-10, 10])
OBJ = random.choice([-10, 10])
SUBJ = random.choice([-10, 10])
