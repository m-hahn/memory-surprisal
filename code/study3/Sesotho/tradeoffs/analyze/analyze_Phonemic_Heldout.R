...
plot = ggplot(data_, aes(x=1+Distance, y=1.44*MI, color=Type)) + geom_line() #size=2)
plot = plot + theme_bw()
...
ggsave(plot, file=paste("../figures/Sesotho-suffixes-byPhonemes-auc-hist-heldout.pdf", sep=""), height=4, width=8)
