...
print("Tokens & Naive   & Optimized for Phoneme Prediction   &   "+results[(evalScript, optimPhon)]+" \\\\")
print("       &         & Optimized for Morpheme Prediction  &   "+results[(evalScript, optimMorph)]+" \\\\ \\hline")
print("       & Heldout & Optimized for Phoneme Prediction   &   "+results[(evalScript, optimPhon_HeldoutClip)]+" \\\\")
print("       &         & Optimized for Morpheme Prediction  &   "+results[(evalScript, optimMorph_HeldoutClip)]+" \\\\ \\hline")
print("       &         &                 Random Baseline    &  "+resultsTypes[(evalScript, "RANDOM")]+" \\\\ \\hline\\hline")
print("Types & Naive    & Optimized for Phoneme Prediction   &   "+resultsTypes[(evalScript, optimPhon)]+" \\\\")
print("      &          & Optimized for Morpheme Prediction  &   "+resultsTypes[(evalScript, optimMorph)]+" \\\\ \\hline")
print("      & Heldout  & Optimized for Phoneme Prediction   &   "+resultsTypes[(evalScript, optimPhon_HeldoutClip)]+" \\\\")
print("      &          & Optimized for Morpheme Prediction  &   "+resultsTypes[(evalScript, optimMorph_HeldoutClip)]+" \\\\ \\hline")
print("      &          & Random Baseline    &  "+resultsTypes[(evalScript, "RANDOM")]+" \\\\")
print("")
print("")
print("")
print("Japanese & Optimized   & -- &  -- &   "+results[(evalScript, optimMorph_HeldoutClip)]+" \\\\")
print("         & Baseline    & -- & --  & "+results[(evalScript, "RANDOM")]+" \\\\ \\hline")
