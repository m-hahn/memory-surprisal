...
import glob
models_sfx = glob.glob(PATH+"optimized_forWords_Japanese_OptimizeOrder_Normalized_FullData*.py_*.tsv")
models_sfx += glob.glob(PATH+"optimized_forWords_Japanese_OptimizeOrder_FormsPhonemesFull_FullData*.py_*.tsv")
