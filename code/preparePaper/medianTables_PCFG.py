...
#   line = languageKey[language]
   ...
   components.append( "\includegraphics[width=0.25\\textwidth]{../code/pcfg-control/analyze_pcfg/figures/"+language+"-listener-surprisal-memory-MEDIANS_onlyWordForms_boundedVocab-pcfg.pdf}" )
