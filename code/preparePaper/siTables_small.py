...
# user@user-X510UAR:~/memory-surprisal/code/analysis/visualize_neural$ evince figures/Amharic-Adap-it_REAL.pdf 
   ...
   components.append( "\includegraphics[width=0.1\\textwidth]{../code/analysis/visualize_neural/figures/"+language+"-it_REAL.pdf}" )
...
part=0
with open("output/it_small.tex", "w") as outFile:
