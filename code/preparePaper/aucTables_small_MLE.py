...
#   line = languageKey[language]
   ...
   components.append( "\includegraphics[width=0.1\\textwidth]{../code/analysis/medians/auc/figures/"+language+"-listener-surprisal-memory-HIST_AUC_onlyWordForms_boundedVocab.pdf}" )
...
part=0
with open("output/auc_small_MLE.tex", "w") as outFile:
