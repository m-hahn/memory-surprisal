...
with open("../create_models/vocab_sizes.tsv", "r") as inFile:
...
#   line = languageKey[language]
   ...
   components.append(pretty(h(stats,languageKey_stats[language], "VocabSize")))
   components.append(pretty(h(stats,languageKey_stats[language], "OOV_Perc")))
...
with open("../../vocabSizes.tex", "w") as outFile:
