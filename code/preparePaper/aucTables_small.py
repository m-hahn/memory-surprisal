...
#   line = languageKey[language]
   ...
   components.append( "\includegraphics[width=0.1\\textwidth]{../code/analysis/medians/auc/figures/"+language+"-listener-surprisal-memory-HIST_AUC_onlyWordForms_boundedVocab_REAL.pdf}" )
...
part=0
with open("output/auc_small.tex", "w") as outFile:
