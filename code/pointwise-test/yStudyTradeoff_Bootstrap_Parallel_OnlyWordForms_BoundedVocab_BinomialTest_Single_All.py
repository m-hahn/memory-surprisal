...
with open("../../results/tradeoff/listener-curve-binomial-test.tsv", "w") as outFile:
  ...
  for language in languages:
     print(language)
     print >> outFile, subprocess.check_output(["./python27", "yStudyTradeoff_Bootstrap_Parallel_OnlyWordForms_BoundedVocab_BinomialTest_Single.py", "--language", language, "--base_directory", "word-level", "--suffix", "_decay_after_tuning_onlyWordForms_boundedVocab"]).strip()
