...
# ~/python27 forWords_Celex_NullLexica.py --language=English --model=REAL_REAL
# shows that phonotactic structure is enough to get good locality

#with open("/juicier/scr120/scr/mhahn/CODE/NullLexicons/celexes/lemma_english_1_0_0_40.txt", "r") as inFile:
with open("/juicier/scr120/scr/mhahn/CODE/NullLexicons/Lexicons/lex_pcfg__lemma_english_1_0_0_40_cv0_iter2_mpcfg_n3_smoothing0.01.txt", "r") as inFile:
#with open("/juicier/scr120/scr/mhahn/CODE/NullLexicons/Lexicons/lex_lemma_english_1_0_0_40_cv0_iter2_mnphone_n3_smoothing0.01.txt", "r") as inFile:
  for line in inFile:
     line = line.strip()
     if len(line) == 0:
       continue
