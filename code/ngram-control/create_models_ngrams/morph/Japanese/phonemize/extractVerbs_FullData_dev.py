...
with open("../data/extractedVerbs_dev.txt", "w") as outFile:
 for verb in data:
   print("".join([x["word"] for x in verb]), file=outFile)
#./kytea /juicier/scr120/scr/mhahn/CODE/memory-surprisal/code/ngram-control/create_models_ngrams/morph/Japanese/data/extractedVerbs_dev.txt > /juicier/scr120/scr/mhahn/CODE/memory-surprisal/code/ngram-control/create_models_ngrams/morph/Japanese/data/extractedVerbs_tagged_dev.txt
