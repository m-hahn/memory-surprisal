...
with open("../../../../results/tradeoff/pcfg/listener-curve-ci-median.tsv", "w") as outFile:
  print >> outFile, "\t".join(["Language", "Type", "Position", "Memory", "MedianEmpirical", "MedianLower", "MedianUpper", "Level"])
  for language in languages:
     print(language)
     print >> outFile, subprocess.check_output(["../python27", "yStudyTradeoff_Bootstrap_Parallel_OnlyWordForms_BoundedVocab_BinomialTest_Single_MedianCI_PCFG.py", language]).strip()
