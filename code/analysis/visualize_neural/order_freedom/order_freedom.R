...
plot = ggplot(dataReal, aes(x=1.44*MIDiff, y=BranchingEntropy)) + geom_point()
...
plot = ggplot(dataReal, aes(y=1.44*MIDiff, x=BranchingEntropy)) + geom_point()
plot = plot + theme_classic() 
plot = plot + theme(legend.position="none")   
...
plot = plot + xlab("Branching Direction Entropy")
plot = plot + theme(axis.title=element_text(size=30))
plot = plot + geom_segment(data=data.frame(y=1.44*0.0999, yend=1.44*0.23, x=0.328, xend=0.2), aes(x=x, xend=xend, y=y, yend=yend), size=2, arrow=arrow(), color="red")
plot = plot + theme(axis.title=element_text(size=30))
plot = plot + theme(axis.text = element_text(size=20))
...
plot = plot + xlab("Branching Direction Entropy")
#plot = plot + theme(axis.title=element_text(size=30))
plot = plot + geom_point(data=data.frame(y=c(1.44*0.0999, 1.44*0.23), x=c(0.328, 0.2), Type=c("Without Information Structure", "With Information Structure")), aes(x=x, y=y, color=Type), size=5)
