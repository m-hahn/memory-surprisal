...
dhWeights[stoi_deps["amod"]] = 10000
dhWeights[stoi_deps["nmod"]] = 10000
dhWeights[stoi_deps["case"]] = -10000
OBJ = 10000 
SUBJ = 10000
...
with open("results-"+__file__+".tsv", "w") as outFile:
   print("\t".join(["Language", "Distance", "Surprisal", "MI", "EE"]), file=outFile)
   ...
   #               print (i, j)
      ...
      print("\t".join([__file__, str(contextLength), str(crossEntropy), str((lastCrossEntropy-crossEntropy) if contextLength > 0 else "NA"), str(memory)]), file=outFile)
