...
dhWeights[stoi_deps["amod"]] = 10 #random.choice([-10, 10])
dhWeights[stoi_deps["nmod"]] = 10 #random.choice([-10, 10])
dhWeights[stoi_deps["case"]] = -10 #random.choice([-10, 10])
dhWeights[stoi_deps["obj"]] = 10 #random.choice([-10, 10])
dhWeights[stoi_deps["nsubj"]] = 10 #random.choice([-10, 10])
dhWeights[stoi_deps["obj_heavy"]] = -10 #random.choice([-10, 10])
dhWeights[stoi_deps["nsubj_heavy"]] = -10 #random.choice([-10, 10])

indices = list(range(len(itos_deps)))
random.shuffle(indices)
for x in range(len(indices)):
  distanceWeights[x] = 10 * indices[x]
distanceWeights[stoi_deps["nsubj"]] = 0.0
distanceWeights[stoi_deps["obj"]] = 0.0
distanceWeights[stoi_deps["nsubj_heavy"]] = 10.0
distanceWeights[stoi_deps["obj_heavy"]] = 10.0
