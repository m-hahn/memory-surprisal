...
#      assert line["dep"] == "root"
   ...
   inner = {"word" : line["word"], "category" :line["posUni"]+"_"+head, "children" : None, "line" : line}
   while rightChildren:
      sibling = rightChildren.pop(0)
      inner = {"category" : line["posUni"]+"_R_"+"_"+head+"_"+line["coarse_dep"], "children" : [inner, sibling], "line" : line}
   while leftChildren:
      sibling = leftChildren.pop(-1)
      inner = {"category" : line["posUni"]+"_L_"+"_"+head+"_"+line["coarse_dep"], "children" : [sibling, inner], "line" : line}
   return inner
