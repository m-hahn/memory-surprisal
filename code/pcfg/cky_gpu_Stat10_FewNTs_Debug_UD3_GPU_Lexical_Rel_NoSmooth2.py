...
#      assert line["dep"] == "root"
   ...
   while rightChildren:
      ...
      inner = {"category" : line["posUni"]+"_"+head+"_"+line["coarse_dep"], "children" : [inner, sibling], "line" : line}
   while leftChildren:
      sibling = leftChildren.pop(-1)
      inner = {"category" : line["posUni"]+"_"+head+"_"+line["coarse_dep"], "children" : [sibling, inner], "line" : line}
   return inner
