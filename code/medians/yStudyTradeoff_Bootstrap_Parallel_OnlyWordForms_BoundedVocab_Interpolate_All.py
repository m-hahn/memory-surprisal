...
with open("../../results/tradeoff/listener-curve-interpolated.tsv", "w") as outFile:
  print >> outFile, "\t".join(["Language", "Type", "FileName", "Position", "Memory", "Surprisal"])
  for language in languages:
     print(language)
     print >> outFile, subprocess.check_output(["../python27", "yStudyTradeoff_Bootstrap_Parallel_OnlyWordForms_BoundedVocab_Interpolate.py", language]).strip()
