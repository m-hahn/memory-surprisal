#  ./python27 yWithMorphologySequentialStreamDropoutDev_BaselineLanguage_Fast_SaveLast_NoFinePOS_OnlyWordForms_FullVocab_RunOptimized.py Chinese Chinese 0.45 200 1024 1 0.1 OPTIM 0.2 2 0.05 20
...
#  with open("/u/scr/mhahn/deps/locality_optimized_i1/Chinese_optimizeGrammarForI1_3.py_model_675523898.tsv", "r") as inFile:
  with open("/u/scr/mhahn/deps/locality_optimized_i1/Cantonese-Adap_optimizeGrammarForI1_3.py_model_535270560.tsv", "r") as inFile:
...
#                   print >> outFile, "\t".join(map(str,[key, dhWeight, distanceWeight]))
          with open(TARGET_DIR+"/RUN_estimates-"+language+"_"+__file__+"_model_"+str(myID)+"_"+model+".txt", "w") as outFile:
              print >> outFile, " ".join(sys.argv)
